...
const Step2: React.FC<Step2Props> = ({
  ...
  const locations = ['Scotland','London', 'South East', 'South West', 'East of England', 'West Midlands', 'East Midlands', 'Yorkshire and the Humber', 'North West', 'North East','Wales','Northern Ireland'];
